      ...
      <div className={styles["order-detail-content"]}>
        ...
        <div className={styles["order-detail-card"]}>
          ...
          <div className={styles["order-detail-info"]}>
            ...
            <p className={styles["order-project-title"]}>여기가 어디인가요? &lt;기억상실&gt;</p>
        ...
        <div className={styles["order-detail-box"]}>
          ...
          <ul className={styles["order-detail-list"]}>
            <li><span>프로젝트 상태</span><span style={{ color: '#F86453' }}>펀딩 진행중</span></li>
            <li><span>후원 상태</span><span>후원 취소</span></li>
            <li><span>후원 번호</span><span>0000001</span></li>
            <li><span>후원 일자</span><span>2025.05.05</span></li>
            <li><span>후원 마감</span><span>2025.05.15</span></li>
          </ul>
          <button className={styles["order-small-button"]} hidden>후원 취소</button>
        </div>
        ...
        <div className={styles["order-detail-box"]}>
          ...
          <ul className={styles["order-detail-list"]}>
            ...
            <li><span>선물 금액</span><span>12,000원</span></li>
          </ul>
          <button className={styles["order-small-button"]} hidden>변경</button>
        </div>
        ...
        <div className={styles["order-detail-box"]}>
          ...
          <ul className={styles["order-detail-list"]}>
            <li><span>추가 후원금</span><span>100원</span></li>
          </ul>
          <button className={styles["order-small-button"]} hidden>변경</button>
        </div>
        ...
        <div className={styles["order-detail-box"]}>
          ...
          <ul className={styles["order-detail-list"]}>
            <li><span>결제 수단</span><span>네이버페이</span></li>
            <li><span>결제 금액</span><span>12,100원</span></li>
            <li><span>결제 상태</span><span>2025.05.16 결제 예약 취소</span></li>
          </ul>
          <button className={styles["order-small-button"]} hidden>변경</button>
        </div>
        ...
        <div className={styles["order-detail-button"]}>
          <button onClick={() => window.location.href = './order-list.html'}>목록 보기</button>
        </div>
      </div>
